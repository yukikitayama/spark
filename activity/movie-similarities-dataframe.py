...
# local[*] means use every CPU core on my local system to execute this job
...
if (len(sys.argv) > 1):
    # Similarity score above 0.97
    scoreThreshold = 0.97
    # At least 50 users made rating on the same movie
    coOccurrenceThreshold = 50.0
    # Movie ID given by command line
